...
export default function Header(){
  return(
    <header className="w-full h-[100px] bg-accent relative flex justify-center items-center flex-shrink-0">
    ...
    <div className="h-full w-[300px]  flex justify-center items-center gap-10">
