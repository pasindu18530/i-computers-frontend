    ...
    <div className="w-full h-full flex flex-col items-center p-4 overflow-y-scroll">
      <div className="sticky top-0 w-full h-[100px] rounded-lg  bg-accent text-white flex items-center p-5 justify-between shadow-2xl ">
        ...
        <div className="h-full justify-center items-center ">
          <button onClick={handleSave} className="ml-4 px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600"disabled={isSaving}>
        ...
        value={category}
         ...
         <div className="border border-gray-300 rounded-md p-2 w-full">
          ...
          <label className="block mb-2 font-semibold">Images</label>
            <input type="file" multiple className="border-gray-300 rounded-md p-2 w-full"
            onChange={
              (e)=>{
